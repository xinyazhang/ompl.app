...
int main(int argc, char* argv[])
{
	...
	std::string env_fname = std::string(OMPLAPP_RESOURCE_DIR) + "/3D/dual_tiny.dt.tcp.obj";
	constexpr double sx = 3.24;
	constexpr double sy = 11.03;
	constexpr double sz = 2.93;
	constexpr double srx = 0.0;
	constexpr double sry = -1.0;
	constexpr double srz = 0.0;
	constexpr double srt = 1.57079632679;
	constexpr double gx = 0.24;
	constexpr double gy = -19.97;
