...
int main(int argc, char* argv[])
{
	...
	std::string env_fname = std::string(OMPLAPP_RESOURCE_DIR) + "/3D/dual.dt.tcp.obj";
	constexpr double sx = 52.24;
	constexpr double sy = 21.03;
	constexpr double sz = -2.07;
	constexpr double srx = 0.0;
	constexpr double sry = 0.0;
	constexpr double srz = 1.0;
	constexpr double srt = 4.71238898038;
	constexpr double gx = 0.24;
	constexpr double gy = -7.97;
	constexpr double gz = -2.07;
	constexpr double grx = 0.0;
	constexpr double gry = -1.0;
	constexpr double grz = 0.0;
	constexpr double grt = 1.57079632679;
