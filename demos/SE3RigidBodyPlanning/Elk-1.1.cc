...
int main(int argc, char* argv[])
{
    ...
    std::string robot_fname = std::string(OMPLAPP_RESOURCE_DIR) + "/3D/Elk-Part-Possion(12,8,4,1.1).ply";
    std::string env_fname = std::string(OMPLAPP_RESOURCE_DIR) + "/3D/Elk-CounterPart-Possion(12,8,4,1.1).ply";
